    ...
    return ( 
        <nav className="flex justify-between items-center nav">
            ...
            <div className="flex row mr-16 ml-10 mt-4">
                ...
                {isAuth?<Link to="/profile/1"><img src={profileImg} alt="profile-img" className="w-12 h-12 cursor-pointer" /></Link>: <Link to="/login"><button className="login-nav regular-font">Login</button></Link>}                
            </div>
        </nav>
    )
}
