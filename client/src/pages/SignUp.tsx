    ...
    return (
        <div className="flex justify-center h-full items-center">
            <div className="h-5/6 main-div flex rounded-md mt-8 bg-white">
                ...
                <svg id="sw-js-blob-svg" className="absolute z-0 h-full w-full signup-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">                    <defs>                         <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">                            <stop id="stop1" stop-color="rgba(156, 187, 242, 1)" offset="0%"></stop>                            <stop id="stop2" stop-color="rgba(156, 187, 242, 1)" offset="100%"></stop>                        </linearGradient>                    </defs>                <path fill="url(#sw-gradient)" d="M11.2,-18.4C16.1,-16.5,23,-16.9,29,-14.2C35.1,-11.5,40.3,-5.7,38.2,-1.2C36.1,3.3,26.7,6.6,23,13.4C19.3,20.1,21.3,30.3,18.4,32.7C15.6,35.1,7.8,29.8,0.4,29.1C-7,28.5,-14,32.4,-19.5,31.5C-25,30.6,-28.9,24.8,-33.7,18.7C-38.5,12.7,-44,6.3,-40.8,1.8C-37.7,-2.7,-25.8,-5.3,-19.1,-8.2C-12.5,-11,-11.2,-14.1,-8.9,-17.6C-6.6,-21.1,-3.3,-25,-0.1,-24.9C3.1,-24.7,6.2,-20.4,11.2,-18.4Z" width="100%" height="100%" transform="translate(50 50)" stroke-width="0" ></path>              </svg>
