...
const blogs = [
    ...
    date:new Date(), tags:tags},
    {id:1,user:'User', image:lake,profilePic:profile,title:"The title goes here...",description:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi dapibus eu lectus id gravida...',
    date:new Date(), tags:tags}
];
